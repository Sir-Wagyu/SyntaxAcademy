...
<?php if (isset($_GET['edit'])): ?>
    ...
    <div id="modal-overlay" class="hidden w-screen h-screen fixed inset-0 bg-black/50 z-[90] transition-all"></div>
    <div id="update-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-[91] justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div class="relative p-4 w-full md:w-[90%] lg:w-[75%] max-h-full">
            <!-- Modal content -->
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700 h-max">
                <!-- Modal header -->
                ...
                <!-- Modal body -->
                <form class="p-4 md:p-5" method="post" id="formEditKursus" action="<?php echo base_url('kursus/updateKursus/' . $k->id_kursus) ?>">
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        ...
                        <div class="col-span-2">
                            ...
                            <div id="editor2" style="height: 250px;"><?php echo $k->description ?></div>
                            <input type="hidden" name="description" id="hiddenDeskripsi2" value="<?php echo $k->description ?>">
                        </div>
                    </div>
                    <button type="submit" class="absolute -bottom-14 text-white inline-flex items-center bg-warna-300 hover:bg-warna-400 focus:ring-4 focus:outline-none focus:ring-warna-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center ">
                        Update Data Kursus
                    </button>
                </form>
            </div>
    ...
    <script>
        ...
        var formKursusEdit = document.querySelector('#formEditKursus');
        formKursusEdit.onsubmit = function() {
            var content = quill.root.innerHTML;
            document.querySelector('#hiddenDeskripsi2').value = content;
        };
    </script>
