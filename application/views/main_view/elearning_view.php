...
<div class="max-w-screen-xl mx-auto px-4 flex gap-5 mt-3 lg:mt-5">
    <div class="hidden lg:block lg:w-[30%] h-max p-4">
        ...
        <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown" class="mt-4 w-full bg-gray-100 py-2 text-left flex justify-between items-center px-4 text-lg" type="button">
            <p>level</p>
            <i class="fa-solid fa-angle-down"></i>
        </button>

        <!-- Dropdown menu -->
        <div id="dropdown" class="z-10 hidden lg:w-[50%] border border-gray-300">
